DEFAULT_LANG_PACKS = {'en': {'app_title': '{brand} {version}',
        ...
        'task.network_throttling_off.desc': 'Sets NetworkThrottlingIndex=ffffffff in Multimedia SystemProfile. This is '
                                            'a common gamer network tweak aimed at reducing packet throttling and '
                                            'latency spikes. Restart required.',
        'task.mmcss_gaming_profile.title': 'Apply MMCSS Games profile',
        'task.mmcss_gaming_profile.desc': 'Tunes SystemResponsiveness to the documented lowest useful value and '
                                          'applies the MMCSS Tasks\\Games gaming profile: GPU Priority, CPU Priority, '
                                          'Scheduling Category, and SFIO Priority. Advanced tweak; test carefully. '
                                          'Restart required.',
        ...
        'update_download_idle': 'The installer will be saved to the updates folder in the FreeCleaner installation '
                                'directory and started automatically after download.',
